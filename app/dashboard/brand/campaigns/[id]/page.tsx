        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              ...
              <Badge tone={campaign.status === "OPEN" ? "green" : "gray"}>
        ...
        {campaign.applications.length === 0 ? (
          ...
          <div className="mt-4 flex flex-col gap-3">
            {campaign.applications.map((application) => (
              <Card key={application.id} className="flex items-start justify-between gap-4 p-5">
                <div>
                  <div className="flex items-center gap-2">
                    <p className="font-semibold text-gray-900">{application.creator.name}</p>
